...
{
    public partial class MPBlank : System.Web.UI.MasterPage
    {
        ...
        private void InitUI()
        {
            ...
            try
            {
                ...
                if (v_objActive_Func != null)
                {
                    litTitle.Text = "<div><img src=\"/Webadmin/Media/img/folder.png\" width=\"47\" height=\"40\" border=\"0\"/></div>"
                        + "<div class=\"class_Header_Blank_Div_Title\">" + v_objActive_Func.Auto_ID + " " + '-' + " " + v_objActive_Func.Ten_Chuc_Nang + "</div>";
                }
            }
